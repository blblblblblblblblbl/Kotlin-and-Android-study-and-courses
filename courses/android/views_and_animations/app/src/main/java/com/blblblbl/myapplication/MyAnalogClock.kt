...
import com.blblblbl.myapplication.databinding.TimerViewBinding
...
class CustomAnalogClock : View {
    ...
    private fun drawHandLine(canvas: Canvas,moment: Int, handRadius:Int,color:Int) {
    ...
    private fun drawlines(canvas: Canvas){
        drawHandLine(canvas,curHour*5,mRadius - mHandTruncation - mHourHandTruncation, HOUR_LINE_COLOR)
    ...
    companion object{
        ...
        private const val MINUTE_LINE_COLOR = Color.WHITE
